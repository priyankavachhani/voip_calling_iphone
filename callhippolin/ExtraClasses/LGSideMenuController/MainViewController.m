...
- (void)setupWithType:(NSUInteger)type {
    ...
    if (self.storyboard) {
        ...
        LeftMenuViewController *vc = [[self storyboard] instantiateViewControllerWithIdentifier: @"LeftMenuViewController"];
        ...
        self.leftViewWidth = screenWidth - 100;
...
//            self.rootViewLayerShadowRadius = 10.0;
            ...
            self.leftViewStatusBarHidden = true;
            self.leftViewStatusBarStyle = UIStatusBarStyleLightContent;
