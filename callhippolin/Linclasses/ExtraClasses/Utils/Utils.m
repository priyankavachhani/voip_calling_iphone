...
//
//    size_t edge = originalHeight;//MIN(originalWidth, originalHeight);
//
...
//        size.width = size.height = size.height; //MAX(size.width, size.height);
//    }
//
...
//
//    hsbB = 1.0;//MIN(MAX(hsbB * mult, 0.0), 1.0);
//
...
////    RGB2HSL(rgbaR, rgbaG, rgbaB, &hsbH, &hsbS, &hsbB);
//
//    hsbH = 1.0;//MIN(MAX(hsbH + hm, 0.0), 1.0);
//    hsbS = 1.0;//MIN(MAX(hsbS + sm, 0.0), 1.0);
//    hsbB = 1.0;//MIN(MAX(hsbB + bm, 0.0), 1.0);
//    rgbaA = 1.0;//MIN(MAX(rgbaA + am, 0.0), 1.0);
//
////    HSL2RGB(hsbH, hsbS, hsbB, &rgbaR, &rgbaG, &rgbaB);
//
//    return [UIColor colorWithRed:rgbaR green:rgbaG blue:rgbaB alpha:rgbaA];
...
//    CGFloat offsetX = 0.0;
//    CGFloat offsetY = 0.0;
//    CGFloat actualTbSize = size.width;//MAX(tbSize, MAX(size.height, size.width));
