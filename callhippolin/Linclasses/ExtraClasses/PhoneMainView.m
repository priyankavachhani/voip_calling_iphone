...
- (void)callUpdate:(NSNotification *)notif {
    ...
    NSLog(@"phone main view:: call update");
...
//        }
//        case LinphoneCallStreamsRunning: {
//          //pr  [self changeCurrentView:CallView.compositeViewDescription];
//            break;
//        }
//        case LinphoneCallUpdatedByRemote: {
//            const LinphoneCallParams *current = linphone_call_get_current_params(call);
...
//              //pr      [PhoneMainView.instance popToView:DialerView.compositeViewDescription];
...
//            break;
//    }
//  /*  //pr if (state == LinphoneCallEnd || state == LinphoneCallError || floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_9_x_Max)
//       [self updateApplicationBadgeNumber];*/
//}
