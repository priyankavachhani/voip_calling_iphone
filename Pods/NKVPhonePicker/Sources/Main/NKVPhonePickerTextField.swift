...
@objc open class NKVPhonePickerTextField: TextFieldPatternFormat {
   ...
   @objc public var country: Country? {
        get {
   ...
   @objc public var code: String? {
    ...
    override public init(frame: CGRect) {
        ...
        initialize()
//        country = Country.country(for: NKVSource(countryCode: "US"))
    }
...
//        return super.textRect(forBounds: bounds.inset(by: textFieldTextInsets ?? UIEdgeInsets.zero))
        ...
        return super.textRect(forBounds: bounds.insetBy(dx: textFieldTextInsets!.left, dy: textFieldTextInsets!.top))
    }
...
extension NKVPhonePickerTextField: UITextFieldDelegate {
    @objc fileprivate func textFieldDidChange() {
       ...
       // print("Trushang Newstring : \(String(describing: self.text))")
        if(self.text.contains("+"))
        {
            let newString = self.text.replacingOccurrences(of: "+", with: "")
          //  print("Trushang Newstring : \(newString)")
                if isFlagFixed == false {
